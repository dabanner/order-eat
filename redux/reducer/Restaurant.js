...
const initialState = {
    ...
    selectedRestaurantInformation: null,
};
...
const Restaurants = createSlice({
    ...
    reducers: {
        ...
        updateSelectedRestaurantId: (state, action) => {
            state.selectedRestaurantId = action.payload;
            state.selectedRestaurantInformation = state.restaurants.find(restaurant => restaurant.id === action.payload);
        }
    },
});

export const {resetRestaurants, updateSelectedRestaurantId} = Restaurants.actions;
